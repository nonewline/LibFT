NAME = libft.a
SRC = ft_atoi.c ft_bzero.c ft_factorial.c ft_foreach.c ft_isalnum.c \
	  ...
	  ft_putstr.c ft_putstr_fd.c ft_sqrt.c ft_strcat.c ft_strchr.c \
...
OBJ = ft_atoi.o ft_bzero.o ft_factorial.o ft_foreach.o ft_isalnum.o \
	  ...
	  ft_memcpy.o ft_memdel.o ft_memmove.o ft_memset.o ft_power.o ft_putchar.o\
	  ft_putchar_fd.o ft_putendl.o ft_putendl_fd.o ft_putnbr.o ft_putnbr_fd.o \
	  ft_putstr.o ft_putstr_fd.o ft_sqrt.o ft_strcat.o ft_strchr.o \
